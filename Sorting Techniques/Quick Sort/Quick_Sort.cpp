...
int partitionA(int A[], int low, int high){
    ...
    do{
        ...
        //Decrement j as longas elements are larger than pivot
...
int main(void){
    ...
    QuickSortLast(B,0,sizeof(A)/sizeof(A[0])-1);
